...
사용예)
 ...
 - RPAD(C1,N[,C2]): 주어진 문자열 'C1'을 N만큼의 크기에 저장하고 남는 기억공간은 (오른쪽) 'C2'를 채움. C2가 생략되면 공백이 채워짐 --빈공간이 오른쪾에, 왼쪽으로 정렬되고
...
6) TRIM(C1)
- 주어진 문자열 C1의 오른쪽과 왼쪽에 존재하는 무효의 공백을 제거--유효의 공백은 글자와 글자 사이, 무효의 공백은 왼쪾이나 오른쪽에 존재하는 공백들
